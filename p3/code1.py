...
def plot(p_list, is_reduced_list_p, title):
    ...
    ax.grid()
    plt.savefig('./phase1-p1/pic-1-' + title + '.png')
    plt.show()
...
erdos_renyi_test(100, 0.5, 300)
watts_strogatz_test(100, 5, 0.5, 300)
barabasi_albert_test(100, 5, 300)

# erdos_network = nx.erdos_renyi_graph(30, 0.5)
# print(len(nx.degree(erdos_network)))