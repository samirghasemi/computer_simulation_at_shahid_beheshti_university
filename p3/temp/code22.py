...
#
# erdos = nx.erdos_renyi_graph(20, 0.5)
...
#
# plots(deactive_erdos_e_time_list, deactive_erdos_e_s_list, deactive_erdos_fi_list, deactive_erdos_pareto_random,deactive_erdos_normal_random, "erdos", "deactive")
...
deactive_erdos_e_time_list, deactive_erdos_e_s_list, deactive_erdos_fi_list, deactive_erdos_pareto_random, deactive_erdos_normal_random = active_lifetime(
    erdos)

plots(deactive_erdos_e_time_list, deactive_erdos_e_s_list, deactive_erdos_fi_list,
      deactive_erdos_pareto_random, deactive_erdos_normal_random, "erdos", "deactive")
